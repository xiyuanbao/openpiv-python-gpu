...
def initiate_validation(d_F, validation_list, d_u_mean, d_v_mean, nb_iter_max, K, Nrow, Ncol, W, Overlap, dt):
    ...
    #case if same dimensions
        ...
        #Xiyuan
        print "#case if same dimensions\n"
        print "d_indeces=",d_indeces 
...
def gpu_interpolate_surroundings(d_F, v_list, Nrow, Ncol, W, Overlap, K, dat):
    ...
    if(interior_ind.size != 0):
        ...
        #Xiyuan
        print "interpolate, gpu_index_update, d_interior_bilinear=",d_interior_bilinear,"\nd_interior_ind=",d_interior_ind
    ...
    if(top_ind.size > 0):
        ...
        # Update values. Return a tmp array and destroy after to avoid GPU memory leak.
        #Xiyuan
        print "sides1,d_top_linear=",d_top_linear,"d_top_ind=",d_top_ind
    ...
    if(bottom_ind.size > 0):
        ...
        #Xiyuan
        print "sides2,d_bottom_linear=",d_bottom_linear,"d_bottom_ind=",d_bottom_ind 
        # Update values. Return a tmp array and destroy after to avoid GPU memory leak.
