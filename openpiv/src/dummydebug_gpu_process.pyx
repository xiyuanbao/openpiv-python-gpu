...
#         print "d_shift:",type(d_shift)
        
#         #Xiyuan
#         winA=d_winA.get()
#         search_area=d_search_area.get()
#         print "winA:",winA.shape, np.mean(winA)
#         print "winB:",search_area.shape, np.mean(search_area)
#         fig,ax = plt.subplots(2,2,figsize=(20,20))
#         lenA=len(winA)
#         for axi,indexc in zip(ax.flatten(),[lenA/4,lenA/3,lenA/2,lenA-1]):
#             im=axi.imshow(search_area[indexc],cmap=plt.cm.gray)
#             plt.colorbar(im,ax=axi,fraction=0.04)
# #         im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
# #         plt.colorbar(im1,ax=ax[1],fraction=0.04)
#         fig.suptitle("winB",fontsize=20)
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"winB_"+str(time.time())+".jpg")
...
#         #Xiyuan
#         winA=d_winA_zp.get()
#         search_area=d_search_area_zp.get()
        
#         print "winAzp:",winA.shape, np.mean(winA)
#         print "winBzp:",search_area.shape, np.mean(search_area)
#         fig,ax = plt.subplots(2,2,figsize=(20,20))
#         lenA=len(winA)
#         for axi,indexc in zip(ax.flatten(),[lenA/4,lenA/3,lenA/2,lenA-1]):
#             im=axi.imshow(search_area[indexc],cmap=plt.cm.gray)
...
# #         im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
# #         plt.colorbar(im1,ax=ax[1],fraction=0.04)
#         fig.suptitle("winBzp",fontsize=20)
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"winBzp_"+str(time.time())+".jpg")
    ...
    def _IWarrange(self, d_frame_a, d_frame_b, d_winA, d_search_area, d_shift):
            ...
            __global__ void windowSlice(float *input, float *output, int window_size, int overlap, int n_col, int w, int batch_size)
        {
            ...
            //printf("IW_size = %d,ind_x= %d,ind_y= %d,diff=%d\\n", IW_size,ind_x,ind_y,diff);
            ...
            {   
                ...
                if (i==batch_size-1 & ind_x== 32 & ind_y == 32 )
                    printf("i=%d,f_range=%d,w_range=%d,input[f_range]=%.6f,output[w_range]=%.6f\\n",i,f_range,w_range,input[f_range],output[w_range]);
            }
        ...
        #Xiyuan
        frame_b=d_frame_b.get()
        plt.figure(figsize=(10,10))
        im=plt.imshow(frame_b,cmap=plt.cm.gray)
        plt.colorbar(im)
        plt.title("frame_b",fontsize=20)
        base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
        plt.savefig(base+"frame_b_"+str(time.time())+".jpg")
        ...
        lenA=len(winA)
        for axi,indexc in zip(ax.flatten(),[lenA/4,lenA/3,lenA/2,lenA-1]):
            im=axi.imshow(winA[indexc],cmap=plt.cm.gray)
            plt.colorbar(im,ax=axi,fraction=0.04)
#         im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
#         plt.colorbar(im1,ax=ax[1],fraction=0.04)
        fig.suptitle("afterwinA",fontsize=20)
        base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
        plt.savefig(base+"afterwinA_"+str(time.time())+".jpg")
        
        
        winB=d_search_area.get()
        fig,ax = plt.subplots(2,2,figsize=(20,20))
        lenB=len(winB)
        for axi,indexc in zip(ax.flatten(),[lenB/4,lenB/3,lenB/2,lenB-1]):
            im=axi.imshow(winB[indexc],cmap=plt.cm.gray)
            plt.colorbar(im,ax=axi,fraction=0.04)
#         im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
#         plt.colorbar(im1,ax=ax[1],fraction=0.04)
        fig.suptitle("beforewinB",fontsize=20)
        base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
        plt.savefig(base+"beforewinB_"+str(time.time())+".jpg")
        
        
        shift=d_shift.get()
        print shift
        if np.max(shift)<1 and np.min(shift)>-1:
            d_search_area = gpuarray.zeros((self.batch_size, self.window_size, self.window_size), np.float32)
#         if(d_shift is None):
            print "Running none d_shift!"
            
            windowSlice(cuda.In(frame_b), d_search_area, self.window_size, self.overlap, self.n_cols, w, self.batch_size, block = (block_size,block_size,1), grid=(grid_size,grid_size) )
#             cuda.Context.synchronize()
    ...
    #         im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
    #         plt.colorbar(im1,ax=ax[1],fraction=0.04)
            fig.suptitle("afterwinB",fontsize=20)
            base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
            plt.savefig(base+"afterwinB_"+str(time.time())+".jpg")
            ...
            windowSlice_shift(cuda.In(frame_b), d_search_area, d_dx, d_dy, self.window_size, self.overlap, self.n_cols, w, h, self.batch_size, block = (block_size,block_size,1), grid=(grid_size,grid_size) )
...
# #         im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
# #         plt.colorbar(im1,ax=ax[1],fraction=0.04)
#         fig.suptitle("Corr:winBzp",fontsize=20)
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"Corr_winBzp_"+str(time.time())+".jpg")
        
        #Xiyuan
#         fig,ax = plt.subplots(1,3,figsize=(18,6))
#         searchAreaFFT=d_searchAreaFFT.get()
#         lentmp=len(searchAreaFFT)
#         im=plt.imshow(np.real(searchAreaFFT[lentmp/2]),cmap=plt.cm.gray)
#         plt.colorbar(im,ax=ax[0],fraction=0.04)
#         ax[0].set_title("searchAreaFFTempty")
        ...
        print "plan:",plan_forward.__dict__
...
#         ax[1].set_title("searchAreaFFT")
        
#         search_area_zp=d_search_area_zp.get()
#         lentmp=len(search_area_zp)
#         im=plt.imshow(search_area_zp[lentmp/2],cmap=plt.cm.gray)
#         plt.colorbar(im,ax=ax[2],fraction=0.04)
#         ax[2].set_title("search_area_zp")
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"foward_FFT_"+str(time.time())+".jpg")
...
# #         im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
# #         plt.colorbar(im1,ax=ax[1],fraction=0.04)
#         fig.suptitle("FFTCorr:winBzp",fontsize=20)
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"FFTCorr_winABzp_"+str(time.time())+".jpg")
        ...
        #Xiyuan
#         tmp=d_tmp.get();searchAreaFFT=d_searchAreaFFT.get();winFFT=d_winFFT.get()
#         print "tmp,searchAreaFFT,winFFT:",tmp.shape,searchAreaFFT.shape,winFFT.shape,\
#                                             np.mean(tmp),np.mean(searchAreaFFT),np.mean(winFFT)
#         lentmp=len(tmp)
        
#         fig,ax = plt.subplots(1,3,figsize=(18,6))
        
#         im=plt.imshow(np.real(tmp[lentmp/2]),cmap=plt.cm.gray)
#         plt.colorbar(im,ax=ax[0],fraction=0.04)
#         ax[0].set_title("tmp")
...
#         im=plt.imshow(np.real(winFFT[lentmp/2]),cmap=plt.cm.gray)
#         plt.colorbar(im,ax=ax[2],fraction=0.04)
#         ax[2].set_title("winFFT")
        
        
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"tmp_FFT_"+str(time.time())+".jpg")
...
#         print corr
#         fig,ax = plt.subplots(2,2,figsize=(20,20))
#         for axi,indexc in zip(ax.flatten(),[70,75,80,85]):
#             im=plt.imshow(corr[indexc],cmap=plt.cm.gray)
#             plt.colorbar(im,ax=axi,fraction=0.04)
# #         im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
# #         plt.colorbar(im1,ax=ax[1],fraction=0.04)
#         fig.suptitle("Corr",fontsize=20)
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"Corr_"+str(time.time())+".jpg")
        return(corr)
...
def WiDIM( np.ndarray[DTYPEi_t, ndim=2] frame_a, 
    ...
    d_frame_b_f = gpuarray.to_gpu(frame_b_f)
#     #Xiyuan
#     print "#########################frame_a b stats#########################"
#     print min_window_size,overlap_ratio,coarse_factor,dt,div_validation,trust_1st_iter,validation_iter,tolerance,div_tolerance,nb_iter_max
#     print "min,max,mean:",np.min(frame_a),np.max(frame_a),np.mean(frame_a)
#     print "min,max,mean:",np.min(frame_b),np.max(frame_b),np.mean(frame_b)
#     print frame_a[::5,::5],frame_b[::5,::5]
#     print "#########################frame_a b stats end#####################"
    
#     #Xiyuan
#     fig,ax = plt.subplots(1,2,figsize=(20,10))
#     im0=ax[0].imshow(frame_a,cmap=plt.cm.gray)
#     plt.colorbar(im0,ax=ax[0],fraction=0.04)
#     im1=ax[1].imshow(frame_b,cmap=plt.cm.gray)
#     plt.colorbar(im1,ax=ax[1],fraction=0.04)
#     fig.suptitle("Input",fontsize=20)
#     base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#     plt.savefig(base+"Input_"+str(time.time())+".jpg")
...
#         #Xiyuan
#         shift=d_shift.get()
#         print "shift shape:",shift[0, :Nrow[K], :Ncol[K]].shape
#         fig,ax = plt.subplots(1,2,figsize=(20,10))
#         im0=ax[0].imshow(shift[0, :Nrow[K], :Ncol[K]],cmap=plt.cm.gray)
#         plt.colorbar(im0,ax=ax[0],fraction=0.04)
#         im1=ax[1].imshow(shift[1, :Nrow[K], :Ncol[K]],cmap=plt.cm.gray)
#         plt.colorbar(im1,ax=ax[1],fraction=0.04)
#         plt.title("Shift Iter"+str(K))
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"d_shift_"+str(K)+"_"+str(time.time())+".jpg")
...
#         #Xiyuan
#         fig,ax = plt.subplots(1,2,figsize=(20,10))
#         im0=ax[0].imshow(i_peak,cmap=plt.cm.gray)
#         plt.colorbar(im0,ax=ax[0],fraction=0.04)
#         im1=ax[1].imshow(j_peak,cmap=plt.cm.gray)
#         plt.colorbar(im0,ax=ax[1],fraction=0.04)
#         plt.title("Non-validated result, iter="+str(K))
#         base = "/home/xbao/LAB_test/PLUME-3_51V-B25_2-11032008/ANALYSIS/DEBUG/"
#         plt.savefig(base+"Disp_"+str(K)+"_"+str(time.time())+".jpg")
...
def gpu_interpolate_surroundings(d_F, v_list, Nrow, Ncol, W, Overlap, K, dat):
    ...
    if(interior_ind.size != 0):
        ...
        d_x1, d_low_x = gpu_array_index(d_F[K, :Nrow[K], 0, 0].copy(), d_low_x, np.float32, ReturnList = True)
        d_x2, d_high_x = gpu_array_index(d_F[K, :Nrow[K], 0, 0].copy(), d_high_x, np.float32, ReturnList = True)
        d_y1, d_low_y = gpu_array_index(d_F[K, 0, :Ncol[K], 1].copy(), d_low_y, np.float32, ReturnList = True)
        d_y2, d_high_y = gpu_array_index(d_F[K, 0, :Ncol[K], 1].copy(), d_high_y, np.float32, ReturnList = True)
        d_x = gpu_array_index(d_F[K+1, :Nrow[K+1], 0, 0].copy(), d_interior_ind_x, np.float32)
        d_y = gpu_array_index(d_F[K+1, 0, :Ncol[K+1], 1].copy(), d_interior_ind_y, np.float32)
        ...
        d_f1 = gpu_array_index(d_F[K,:Nrow[K],:Ncol[K],dat].copy(), d_f1_ind, np.float32)
        d_f2 = gpu_array_index(d_F[K,:Nrow[K],:Ncol[K],dat].copy(), d_f2_ind, np.float32)
        d_f3 = gpu_array_index(d_F[K,:Nrow[K],:Ncol[K],dat].copy(), d_f3_ind, np.float32)
        d_f4 = gpu_array_index(d_F[K,:Nrow[K],:Ncol[K],dat].copy(), d_f4_ind, np.float32)
    ...
    if(top_ind.size > 0):
        ...
        d_y1, d_low_y = gpu_array_index(d_F[K, 0, :, 1].copy(), d_low_y, np.float32, ReturnList = True)
        d_y2, d_high_y = gpu_array_index(d_F[K, 0, :, 1].copy(), d_high_y, np.float32, ReturnList = True)
        d_y, d_top_ind = gpu_array_index(d_F[K+1, 0, :, 1].copy(), d_top_ind, np.float32, ReturnList = True)
    ...
    if(bottom_ind.size > 0):
        ...
        # Get values to compute interpolation
        d_y1, d_low_y = gpu_array_index(d_F[K, Nrow[K]-1, :, 1].copy(), d_low_y, np.float32, ReturnList = True)
        d_y2, d_high_y = gpu_array_index(d_F[K, Nrow[K]-1, :, 1].copy(), d_high_y, np.float32, ReturnList = True)
        d_y, d_bottom_ind = gpu_array_index(d_F[K+1, Nrow[K+1]-1, :, 1].copy(), d_bottom_ind, np.float32, ReturnList = True)
        
        # return the values of the function surrounding the validation point
        d_f1 = gpu_array_index(d_F[K, Nrow[K]-1, :, dat].copy(), d_low_y, np.float32)
        d_f2 = gpu_array_index(d_F[K, Nrow[K]-1, :, dat].copy(), d_high_y, np.float32)
    ...
    if(left_ind.size > 0):
        ...
        # Get values to compute interpolation       
        d_x1, d_low_x = gpu_array_index(d_F[K, :, 0, 0].copy(), d_low_x, np.float32, ReturnList = True)
        d_x2, d_high_x = gpu_array_index(d_F[K, :, 0, 0].copy(), d_high_x, np.float32, ReturnList = True)
        d_x, d_left_ind = gpu_array_index(d_F[K+1, :, 0, 0].copy(), d_left_ind, np.float32, ReturnList = True)
    ...
    if(right_ind.size > 0):
        ...
        # Get values to compute interpolation       
        d_x1, d_low_x = gpu_array_index(d_F[K, :, Ncol[K]-1, 0].copy(), d_low_x, np.float32, ReturnList = True)
        d_x2, d_high_x = gpu_array_index(d_F[K, :, Ncol[K]-1, 0].copy(), d_high_x, np.float32, ReturnList = True)
        d_x, d_right_ind = gpu_array_index(d_F[K+1, :, Ncol[K+1]-1, 0].copy(), d_right_ind, np.float32, ReturnList = True)     
        
        # return the values of the function surrounding the validation point
        d_f1 = gpu_array_index(d_F[K, :, Ncol[K]-1, dat].copy(), d_low_x, np.float32)
        d_f2 = gpu_array_index(d_F[K, :, Ncol[K]-1, dat].copy(), d_high_x, np.float32)
...
def gpu_rms(d_neighbours, d_neighbours_present, Nrow, Ncol):
    ...
    __global__ void v_rms_k(float *v_rms, float *n,float *np, int Nrow, int Ncol)
    {
        ...
        // Ncol : number of columns in the arrays
